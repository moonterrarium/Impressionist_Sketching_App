...
public class MainActivity extends AppCompatActivity implements OnMenuItemClickListener {
    ...
    private static String[] IMAGE_URLS ={
            "http://i.imgur.com/n0q4Jnf.jpg",
            "http://www.shadesofgreensa.com/Images/Succulent%20Pictures/succulent.jpg",
            "https://s-media-cache-ak0.pinimg.com/564x/c2/f9/a0/c2f9a0d7c015d23aefc5bfc3c833377e.jpg",
    };
    ...
    public void onButtonClickSetLight(View v) {
        PopupMenu popupMenu = new PopupMenu(this, v);
        popupMenu.setOnMenuItemClickListener(this);
        popupMenu.inflate(R.menu.light_menu);
        popupMenu.show();
    ...
    public boolean onMenuItemClick(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menuCircleSplatter:
                ...
                return true;
            case R.id.Light:
                Toast.makeText(this, "Lightened Colors", Toast.LENGTH_SHORT).show();
                _impressionistView.setColorMod(ImpressionistView.MyColor.BRIGHT);
                return true;
            case R.id.Normal:
                Toast.makeText(this, "Original Colors", Toast.LENGTH_SHORT).show();
                _impressionistView.setColorMod(ImpressionistView.MyColor.NORMAL);
                return true;
            case R.id.Dark:
                Toast.makeText(this, "Darkened Colors", Toast.LENGTH_SHORT).show();
                _impressionistView.setColorMod(ImpressionistView.MyColor.DARK);
                return true;
        }
        return false;
    }
    ...
    public void onButtonClickDownloadImages(View v){
        ...
        saveDialog.setMessage("Save drawing to device photo allery?");
